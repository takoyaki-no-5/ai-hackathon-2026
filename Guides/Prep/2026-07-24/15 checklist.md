...
枠: **19:45–20:20**（35分）。担当: **K**（F は [[Guides/Prep/2026-07-24/F parallel|F 並行]] で同項目確認）。
...
- [ ] 会場 Wi‑Fi 不明 → **テザリングB** の手順を言える（[[Guides/Prep/2026-07-23/14 tethering|#14]]）
- [ ] スマホの充電・データ残量
...
- [ ] 尖りが死んだとき: もう一方 / デモ画像静的 / 失敗文言（[[Guides/Prep/2026-07-23/R2d demo escape|R2d]]）
...
次: [[Guides/Prep/2026-07-24/R3 demo|R3]]
