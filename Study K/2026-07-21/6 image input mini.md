...
```
既存の Agent（useChat + /api/chat）に画像入力を最小追加して。
- 画面で image/* を選べる
- Vision（gpt-4o-mini 可）で説明がストリーム表示
- AI SDK の attachment 書き方がバージョン違いなら最新に合わせて
- 尖り以外のリファクタ禁止。20:30までに動く最小で止めて
```
...
次の日: [[Study K/2026-07-22/README|7/22]]
